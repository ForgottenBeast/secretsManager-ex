defmodule RotatingSecrets.Source.Vault.Auth.Dispatcher do
  ...
  def init({:zitadel_oidc, opts}, req), do: wrap(ZitadelOidc.init(opts, req), :zitadel_oidc)
  ...
  def ensure_fresh({:zitadel_oidc, s}, req), do: rewrap(ZitadelOidc.ensure_fresh(s, req), :zitadel_oidc)
